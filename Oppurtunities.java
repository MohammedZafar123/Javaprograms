...
public class Oppurtunities {
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.xpath("//input[@placeholder='Search Accounts...']")).sendKeys("Zafar");
		driver.findElement(By.xpath("//strong[text()='Zafar']")).click();
		...
		driver.findElement(By.xpath("(//div[@class='slds-form-element__control slds-grow']//input)[3]")).sendKeys("Zafar");
